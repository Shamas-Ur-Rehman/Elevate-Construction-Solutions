...
const Form = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-gray-100 to-white flex justify-center items-center p-4"
    >
      <motion.div
        initial={{ scale: 0.8 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5 }}
        className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-3xl transform transition-all hover:shadow-3xl border border-gray-200"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <button
              type="submit"
              disabled={isLoading}
              className="bg-blue-900 text-white px-8 py-3 rounded-lg hover:bg-orange-600 transition duration-300 transform hover:scale-105"
            >
